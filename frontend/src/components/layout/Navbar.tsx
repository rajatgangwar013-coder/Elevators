...
//                         className="block px-5 py-3 font-ui text-[11px] font-medium tracking-[0.1em] uppercase text-silver hover:text-yellow-400-glow hover:bg-blue-muted transition-all duration-200 cursor-none">
//                         {child.label}
//                       </Link>
//                     ))}
//                   </motion.div>
...
//             <Link href={link.href}
//               className="font-display text-[clamp(28px,7vw,52px)] font-light text-brand-white no-underline tracking-[0.04em] hover:text-yellow-400-glow transition-colors duration-300 cursor-none">
//               {link.label}
//             </Link>
//           </motion.div>
//         ))}
